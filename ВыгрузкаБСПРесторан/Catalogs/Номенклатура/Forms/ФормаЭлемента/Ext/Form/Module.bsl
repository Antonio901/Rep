...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЦентрМониторинга.ЗаписатьОперациюБизнесСтатистики("Справочник.Номенклатура.ПриСозданииНаСервере", 1, Комментарий);
	...
	КонецЕсли;
	ИмяОперации = "Справочник;Номенклатура;ПриСозданииНаСервере;" + ПараметрБизнесСтатистики;
...
Процедура ПриОткрытии(Отказ)
    ...
    УникальныйИдентификаторЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "ПриОткрытииРучнойЗамер");
