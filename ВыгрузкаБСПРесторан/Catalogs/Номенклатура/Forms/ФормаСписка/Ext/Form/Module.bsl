...
// СтандартныеПодсистемы.ОценкаПроизводительности
	...
	КлючеваяОперация = "ОткрытиеФормыЭлемента";
	ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина, КлючеваяОперация);
	
	КлючеваяОперация = "ОткрытиеФормыЭлементаТехнологическая";
	...
	КлючеваяОперация = "ОткрытиеФормыЭлементаПроизвольныйКомментарий";
	УИДЗамераСКомментарием = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Истина, КлючеваяОперация);
	Комментарий = НСтр("ru = 'Произвольный комментарий'");
...
Процедура ЗаменитьИУдалить(Команда)
    ...
    // СтандартныеПодсистемы.ОценкаПроизводительности
    ЦентрМониторингаКлиент.ЗаписатьОперациюБизнесСтатистики("ИнформацияКлиента.Номенклатура.ЗаменитьИУдалить.Нажатие", 1);
    // Конец СтандартныеПодсистемы.ОценкаПроизводительности
