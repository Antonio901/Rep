...
Процедура ОбработкаВыбора(РезультатВыбора, ИсточникВыбора)
	...
	Если ВРег(ИсточникВыбора.ИмяФормы) = ВРег("Справочник.БанковскиеСчета.Форма.РеквизитыБанка") Тогда
...
Процедура УправлениеЭлементамиФормы(Форма)
	...
	ЭтоСчетОрганизации = (ТипЗнч(Форма.Объект.Владелец) = Тип("СправочникСсылка.Организации"));
...
Процедура РеквизитБанкаОткрытие(ИмяЭлемента)
	...
	ОткрытьФорму("Справочник.БанковскиеСчета.Форма.РеквизитыБанка",СтруктураПараметров, ЭтотОбъект);
