...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ГруппыДляРазмещения.Добавить(СправочникНаборы.СправочникКонтрагенты_Основное, Элементы.ГруппаОсновное.Имя);
	...
	ИсключаемыеВиды.Добавить(Справочники.ВидыКонтактнойИнформации.SkypeКонтрагенты);
