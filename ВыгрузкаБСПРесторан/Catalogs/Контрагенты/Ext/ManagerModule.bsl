...
//
// Параметры:
//   Команды - ТаблицаЗначений - добавить в таблицу собственные подключаемые команды. Состав колонок см. в описании
...
//
Процедура ДобавитьЭДВАНСКоманды(ЭДВАНСКоманды, Параметры) Экспорт
