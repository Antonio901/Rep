...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИдентификаторыТипов.Добавить(ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Документ.ОприходованиеТоваров"));
	ИдентификаторыТипов.Добавить(ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Документ.ПеремещениеТоваров"));
	ИдентификаторыТипов.Добавить(ОбщегоНазначения.ИдентификаторОбъектаМетаданных("Документ.СписаниеТоваров"));
	
	МетаданныеТипов = Новый Массив;
	МетаданныеТипов.Добавить(Метаданные.Документы.ОприходованиеТоваров);
	МетаданныеТипов.Добавить(Метаданные.Документы.ПеремещениеТоваров);
	МетаданныеТипов.Добавить(Метаданные.Документы.СписаниеТоваров);
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ГрупповоеИзменениеОбъектов")
	 Или Не ПравоДоступа("Редактирование", Метаданные.РегистрыСведений.РеестрСкладскихДокументов) Тогда
	...
	ПараметрыРазмещения.Источники = Метаданные.РегистрыСведений.РеестрСкладскихДокументов.Измерения.Ссылка.Тип;
	...
	ПараметрыРазмещения.Источники = Новый ОписаниеТипов("ДокументСсылка.РеализацияТоваров");
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ОприходованиеТоваров"
	 Или ИмяСобытия = "Запись_ПеремещениеТоваров"
	 Или ИмяСобытия = "Запись_СписаниеТоваров" Тогда
...
Функция ИмяФормыДокумента(Ссылка)
	...
	Если ТипЗнч(Ссылка) = Тип("ДокументСсылка.ОприходованиеТоваров") Тогда
		ИмяФормыДокумента = "Документ.ОприходованиеТоваров.ФормаОбъекта"
		
	ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.ПеремещениеТоваров") Тогда
		ИмяФормыДокумента = "Документ.ПеремещениеТоваров.ФормаОбъекта"
	
	ИначеЕсли ТипЗнч(Ссылка) = Тип("ДокументСсылка.СписаниеТоваров") Тогда
		ИмяФормыДокумента = "Документ.СписаниеТоваров.ФормаОбъекта"
	Иначе
