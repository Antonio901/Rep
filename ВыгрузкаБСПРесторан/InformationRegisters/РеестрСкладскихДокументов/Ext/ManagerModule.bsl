...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	ИЗ
	|		Документ.СписаниеТоваров КАК СписаниеТоваров) КАК ВсеДокументы
	|
	|УПОРЯДОЧИТЬ ПО
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ОбновитьРеестрСкладскихДокументовУказанногоВида(Параметры, "Документ.ОприходованиеТоваров", ОбработкаЗавершена);
	ОбновитьРеестрСкладскихДокументовУказанногоВида(Параметры, "Документ.ПеремещениеТоваров", ОбработкаЗавершена);
	ОбновитьРеестрСкладскихДокументовУказанногоВида(Параметры, "Документ.СписаниеТоваров", ОбработкаЗавершена);
