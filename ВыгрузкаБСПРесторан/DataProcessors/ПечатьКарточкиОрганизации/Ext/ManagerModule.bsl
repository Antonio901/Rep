...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Настройки.Размещение.Добавить(Метаданные.Справочники.Организации);
КонецПроцедуры
...
Функция СформироватьКарточкуОрганизации(СписокОрганизаций, ОбластиОбъектов) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Обработка.ПечатьКарточкиОрганизации.ПФ_MXL_КарточкаОрганизации");
...
Функция СведенияОбОрганизациях(СписокОрганизаций)
	...
	Для Каждого Организация Из СписокОрганизаций Цикл
		...
		КонтактнаяИнформация = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов(
			ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Организация),,, ТекущаяДатаСеанса());
		...
		|ГДЕ
		|	ОтветственныеЛица.Организация = &Организация";
