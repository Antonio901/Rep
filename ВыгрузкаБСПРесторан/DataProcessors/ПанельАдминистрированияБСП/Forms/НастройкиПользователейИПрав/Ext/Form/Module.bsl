...
Процедура ОграничиватьДоступНаУровнеЗаписейПриИзменении(Элемент)
	...
	Иначе
		...
		Если НаборКонстант.ОграничиватьДоступПоПартнерам Тогда
			НаборКонстант.ОграничиватьДоступПоПартнерам = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ОграничиватьДоступПоПартнерам);
		КонецЕсли;
		Если НаборКонстант.ОграничиватьДоступПоНоменклатуре Тогда
			НаборКонстант.ОграничиватьДоступПоНоменклатуре = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ОграничиватьДоступПоНоменклатуре);
		КонецЕсли;
		Если НаборКонстант.ОграничиватьДоступПоФизическимЛицам Тогда
			НаборКонстант.ОграничиватьДоступПоФизическимЛицам = Ложь;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ОграничиватьДоступПоФизическимЛицам);
		КонецЕсли;
...
Функция ПриИзмененииРеквизитаСервер(ИмяЭлемента)
	...
	Попытка
		Если НаборКонстант.ОграничиватьДоступНаУровнеЗаписей
			...
			И Не НаборКонстант.ОграничиватьДоступПоПартнерам
			И ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.УправлениеДоступом") Тогда
			// Установка зависимой настройки.
			НаборКонстант.ОграничиватьДоступПоПартнерам = Истина;
			КонстантаИмя = СохранитьЗначениеРеквизита(Элементы.ОграничиватьДоступПоПартнерам.ПутьКДанным);
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступНаУровнеЗаписей" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ОграничиватьДоступПоНоменклатуре.Доступность    = ЕстьДоступность;
		Элементы.ОграничиватьДоступПоФизическимЛицам.Доступность = ЕстьДоступность;
	КонецЕсли;
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступПоНоменклатуре" ИЛИ РеквизитПутьКДанным = "" Тогда
		Элементы.ОткрытьГруппыДоступаНоменклатуры.Доступность = НаборКонстант.ОграничиватьДоступПоНоменклатуре;
	КонецЕсли;
	Если РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступНаУровнеЗаписей"
	 Или РеквизитПутьКДанным = "НаборКонстант.ОграничиватьДоступПоПартнерам"
	 Или РеквизитПутьКДанным = "НаборКонстант.ИспользоватьВнешнихПользователей"
	 Или РеквизитПутьКДанным = "" Тогда
		Элементы.ОграничиватьДоступПоПартнерам.Доступность =
			  НаборКонстант.ОграничиватьДоступНаУровнеЗаписей
			И Не НаборКонстант.ИспользоватьВнешнихПользователей
			И Не ОбщегоНазначения.ЭтоАвтономноеРабочееМесто();
		Элементы.ОграничиватьДоступПоПартнерамПредупреждение.Видимость =
			НаборКонстант.ОграничиватьДоступНаУровнеЗаписей
			И НаборКонстант.ИспользоватьВнешнихПользователей;
	КонецЕсли;
