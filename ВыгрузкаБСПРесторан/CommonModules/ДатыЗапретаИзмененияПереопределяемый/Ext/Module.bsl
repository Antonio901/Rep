...
Процедура НастройкаИнтерфейса(НастройкиРаботыИнтерфейса) Экспорт
	...
	СтандартныеПодсистемы.НастройкаИнтерфейса(НастройкиРаботыИнтерфейса);
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	СтандартныеПодсистемы.ПриЗаполненииРазделовДатЗапретаИзменения(Разделы);
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	СтандартныеПодсистемы.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	СтандартныеПодсистемы.ПередПроверкойЗапретаИзменения(
