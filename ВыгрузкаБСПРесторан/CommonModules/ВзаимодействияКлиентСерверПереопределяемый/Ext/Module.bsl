...
Процедура ПриОпределенииВозможныхПредметов(ТипыПредметов) Экспорт
	...
	ТипыПредметов.Добавить("ДокументСсылка.ЗаказПокупателя");
...
Процедура ПриОпределенииВозможныхКонтактов(ТипыКонтактов) Экспорт
	...
	Контакт.Тип = Тип("СправочникСсылка.Партнеры");
	Контакт.Имя = "Партнеры";
	Контакт.Представление = НСтр("ru = 'Партнеры'");
	Контакт.Иерархический = Истина;
	ТипыКонтактов.Добавить(Контакт);
	
	Контакт = ВзаимодействияКлиентСервер.НовоеОписаниеКонтакта();
	Контакт.Тип = Тип("СправочникСсылка.КонтактныеЛицаПартнеров");
	Контакт.Имя = "КонтактныеЛицаПартнеров";
	Контакт.Представление = НСтр("ru = 'Контактные лица партнеров'");
	Контакт.ЕстьВладелец = Истина;
	Контакт.ИмяВладельца = "Партнеры";
	ТипыКонтактов.Добавить(Контакт);
