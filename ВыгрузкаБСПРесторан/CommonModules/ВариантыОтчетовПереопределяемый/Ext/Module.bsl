...
//	Разделы.Добавить(Метаданные.Подсистемы.БизнесПроцессыИЗадачи,   НСтр("ru = 'Отчеты по задачам'"));
//	Разделы.Добавить(Метаданные.Подсистемы.Анкетирование,           НСтр("ru = 'Отчеты по анкетированию'"));
	Разделы.Добавить(Метаданные.Подсистемы.ИнструментыРазработчика, НСтр("ru = 'Отчеты разработчика'"));
//	Разделы.Добавить(Метаданные.Подсистемы.Органайзер.Подсистемы.РаботаСФайлами);
//	Разделы.Добавить(Метаданные.Подсистемы.ИнтегрируемыеПодсистемы, НСтр("ru = 'Отчеты интегрируемых подсистем'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДинамикаИзмененийФайлов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ФайлыВспомогательный);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОборотноСальдоваяВедомость);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.СтатусыЗаказовПокупателей);
	...
	ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ОтчетПоСчетамНаОплатуГлобальный).Включен = Ложь;
	ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ОтчетПоСчетамНаОплатуКонтекстный).Включен = Ложь;
	
	//ЭДВАНС
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.УниверсальныйОтчет);
	ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.УниверсальныйОтчет).Включен = Истина;
КонецПроцедуры
