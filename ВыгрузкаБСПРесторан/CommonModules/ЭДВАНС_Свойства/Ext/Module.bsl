...
//
Процедура ОбновитьИспользованиеВнешнихПользователейПриЗаписи(Источник, Отказ) Экспорт
...
Процедура ЗаполнитьНаборСвойствКонтрагентов(Объект, ТипСсылки, НаборыСвойств)
	...
	Строка = НаборыСвойств.Добавить();
	Строка.Набор = Справочники.НаборыДополнительныхРеквизитовИСведений.СправочникКонтрагенты_Основное;
	
	Строка = НаборыСвойств.Добавить();
	Строка.Набор = Справочники.НаборыДополнительныхРеквизитовИСведений.СправочникКонтрагенты_Прочее;
