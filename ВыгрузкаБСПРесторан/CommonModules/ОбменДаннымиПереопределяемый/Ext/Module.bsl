...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.ОбменБезИспользованияПравилКонвертации);
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.ОбменСБиблиотекойСтандартныхПодсистем);
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.ОбменСБиблиотекойСтандартныхПодсистем225);
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	Если    ТипЗнч(Получатель) = Тип("ПланОбменаСсылка.ОбменСБиблиотекойСтандартныхПодсистем")
		Или ТипЗнч(Получатель) = Тип("ПланОбменаСсылка.ОбменБезИспользованияПравилКонвертации")
		Или ТипЗнч(Получатель) = Тип("ПланОбменаСсылка.ОбменВРаспределеннойИнформационнойБазе")
		Или ТипЗнч(Получатель) = Тип("ПланОбменаСсылка.ОбменСБиблиотекойСтандартныхПодсистем225")
		Или ТипЗнч(Получатель) = Тип("ПланОбменаСсылка.СинхронизацияДанныхЧерезУниверсальныйФормат") Тогда
...
Процедура ПриКоллизииИзмененийДанных(Знач ЭлементДанных, ПолучениеЭлемента, Знач Отправитель, Знач ПолучениеОтГлавного) Экспорт
	...
	Если ТипЗнч(Отправитель) = Тип("ПланОбменаСсылка.ОбменВРаспределеннойИнформационнойБазе") Тогда
		...
		// Разбор коллизий для плана обмена "ОбменВРаспределеннойИнформационнойБазе".
	...
	ИначеЕсли ТипЗнч(Отправитель) = Тип("ПланОбменаСсылка.АвтономнаяРабота") Тогда
		...
		// Разбор коллизий для плана обмена "АвтономнаяРабота".
