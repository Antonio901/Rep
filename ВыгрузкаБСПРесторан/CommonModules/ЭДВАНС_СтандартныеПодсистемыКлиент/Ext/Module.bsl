...
//  (роль "печать непроведенных документов" используется, как дополнительное право с ограничением доступа).
//
// Параметры:
//  ПараметрыПечати - Структура - описание команды печати, подробнее см. УправлениеПечатью.СоздатьКоллекциюКомандПечати.
//
...
Функция ПроверитьРазрешениеНаПечать(ПараметрыПечати) Экспорт
	ПоказатьПредупреждение(, ЭДВАНС_СтандартныеПодсистемыВызовСервера.ПечатьРазрешена(ПараметрыПечати.ОбъектыПечати[0]));
	Возврат Неопределено;
КонецФункции

////////////////////////////////////////////////////////////////////////////////
// Подсистема "Заполнение объектов".
...
////////////////////////////////////////////////////////////////////////////////
// Подсистема "Базовая функциональность" (ОбщегоНазначенияКлиентПереопределяемый).
...
Процедура ЗаполнитьПримечание(МассивОбъектов, ДополнительныеПараметры) Экспорт
	...
	ОткрытьФорму("ОбщаяФорма.Примечание", Новый Структура("ПараметрыПодключаемыхКоманд", Форма.ПараметрыПодключаемыхКоманд), Форма, Форма.УникальныйИдентификатор);	
	
КонецПроцедуры

////////////////////////////////////////////////////////////////////////////////
// Подсистема "Центр мониторинга" (ОбщегоНазначенияКлиентПереопределяемый).
Процедура ПриНачалеРаботыСистемыЦентрМониторинга() Экспорт
    
    СисИнфо = Новый СистемнаяИнформация();
    ОперативнаяПамять = Формат((ЦЕЛ(СисИнфо.ОперативнаяПамять/512) + 1) * 512, "ЧГ=0");
    ИмяОперации = "СтатистикаКлиента.ИнформацияОСистеме.ОперативнаяПамять." + ОперативнаяПамять; 
