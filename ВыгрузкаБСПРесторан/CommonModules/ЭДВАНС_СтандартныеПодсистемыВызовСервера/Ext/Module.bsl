...
Функция ПечатьРазрешена(СсылкаНаДокумент) Экспорт
	...
	Если УправлениеДоступом.ЕстьРоль("ПечатьНепроведенныхДокументов", СсылкаНаДокумент) Тогда
		Возврат
			НСтр("ru = 'Печать этого непроведенного документа разрешена, поскольку документ
			           ...
			           |в профиль включена роль ""Печать непроведенных документов"".'");
	Иначе
		Возврат
			НСтр("ru = 'Печать этого непроведенного документа запрещена, поскольку либо документ
				       ...
				       |в профиль не включена роль ""Печать непроведенных документов"".'");
	КонецЕсли;
