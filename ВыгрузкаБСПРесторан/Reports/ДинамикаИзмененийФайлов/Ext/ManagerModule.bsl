...
Функция ВариантыНастроек() Экспорт
	...
	Результат.Добавить(Новый Структура("Имя, Представление", "Дополнительный1", НСтр("ru = 'Дополнительный 1'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "Дополнительный2", НСтр("ru = 'Дополнительный 2'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "Дополнительный3", НСтр("ru = 'Дополнительный 3'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "Дополнительный4", НСтр("ru = 'Дополнительный 4'")));
	Результат.Добавить(Новый Структура("Имя, Представление", "Дополнительный5", НСтр("ru = 'Дополнительный 5'")));
	Возврат Результат;
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета.Размещение.Удалить(Метаданные.Подсистемы.Органайзер.Подсистемы.РаботаСФайлами);
	...
	НастройкиВарианта.Размещение.Вставить(Метаданные.Подсистемы.Органайзер.Подсистемы.ВариантыОтчетов, "Важный");
